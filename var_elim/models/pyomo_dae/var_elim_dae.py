...
from var_elim.models.pyomo_dae.reaction_kinetics import simple_optimization_model
...
def main():
    m = simple_optimization_model(nfe = 2000)
    ...
    #var_list, con_list = identify_vars_for_elim_min_degree(m, eliminate_bounded_vars=True, eliminate_linear_cons_only=False)
    var_list, con_list = identify_vars_for_elim_min_degree(m, eliminate_bounded_vars=True, eliminate_linear_cons_only=True)
    t1 = time.time() - t0
