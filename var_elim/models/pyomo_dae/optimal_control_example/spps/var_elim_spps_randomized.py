...
from var_elim.models.pyomo_dae.optimal_control_example.spps.optimal_control_SPPS import make_model
...
path = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/data/randomized_data/spps/'
path_ampl = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/data/randomized_data/spps/randomized_ampl/'
path_vm = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/data/randomized_data/spps/randomized_var_major/'
path_cm = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/data/randomized_data/spps/randomized_con_major/'
for i in range(0,5):
    timing_data = {}
    #nfe = 2000, ncp =5
    m_ampl =  make_model(nfe = 50, ncp = 3)
