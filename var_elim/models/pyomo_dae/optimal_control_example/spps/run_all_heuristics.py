...
import sys
import dill
#Note: Heuristic 12 fails in restoration for this problem 
...
path = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/models/pyomo_dae/optimal_control_example/spps/reduced_models'
for i in range(0,13):
    print(i)
    m = make_model(nfe = 50, ncp = 3)
    if i == 0:
