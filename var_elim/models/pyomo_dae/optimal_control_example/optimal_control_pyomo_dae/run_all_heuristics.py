...
path = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/models/pyomo_dae/optimal_control_example/optimal_control_pyomo_dae/reduced_models'
for i in range(0,13):
    print(i)
    m = make_model(nfe = 5000, ncp = 10)
    if i == 0:
