...
path = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/data/randomized_data/optimal_control/'
path_ampl = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/data/randomized_data/optimal_control/randomized_ampl/'
path_vm = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/data/randomized_data/optimal_control/randomized_var_major/'
path_cm = r'/auto/nest/nest/u/sakshi/VarElem/variable-elimination/var_elim/data/randomized_data/optimal_control/randomized_con_major/'
for i in range(0,5):
    timing_data = {}
    #nfe = 2000, ncp =5
    m_ampl =  make_model(nfe = 5000, ncp = 10)
    ...
    timing_data = {}
    m_var =  make_model(nfe = 5000, ncp = 10)
    ...
    #Make model again to make sure it is not initialized to the previous solution
    timing_data = {}
    m_con =  make_model(nfe = 5000, ncp = 10)
